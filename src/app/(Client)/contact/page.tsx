...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with Panchayat Samiti Wai for any queries or assistance",
};
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          We're here to help! Reach out to us for any queries, assistance, or
      ...
      <section className="mb-12">
        <Card className="p-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Button className="bg-govt-blue text-white hover:bg-govt-blue/90 h-auto p-4 flex-col">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3">
              ...
              <p className="text-blue-800">
                <strong>Emergency Services:</strong> For urgent matters, please
                contact the respective department directly or visit the office
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-blue-800">
                <strong>Response Time:</strong> We aim to respond to all queries
                within 2-3 working days. For urgent matters, please call
                directly.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-blue-800">
                <strong>Visit Requirements:</strong> Please carry valid ID proof
                when visiting our office. Some services may require prior
                appointment.
              </p>
            </div>
          </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-yellow-700">
              <strong>TODO:</strong> Contact information and department details
              will be made dynamic and editable from the admin panel in future
              updates. Currently using static content.
            </p>
          </div>
        </div>
      </div>
